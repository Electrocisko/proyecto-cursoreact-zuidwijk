                ...
                <div className='card'>
                   <div className='stock-text'>Stock: {stock}</div>
                    <div className='contenedor__botones'>
                        <button className='boton card__boton' onClick={()=>restar()}><i className="fa-solid fa-minus"></i></button>
                        <input className='card__stock' readOnly value={count} />
                        <button className='boton card__boton' onClick={()=>sumar()}><i className="fa-solid fa-plus"></i></button> 
                    </div>
