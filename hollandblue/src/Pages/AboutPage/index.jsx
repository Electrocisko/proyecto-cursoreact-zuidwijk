    ...
    return (
        <div>
            ...
            <div className='container-text-about'>
                ...
                <img src={Vaca} alt='Foto de una estatuilla de vaca'/>
                ...
                <div className='about-container-fotos'>
                    ...
                    <p>La cerámica de Delft incluye piezas singulares, además de una importante producción de platos, jarrones y azulejería de paramentos y el típico azulejo figurativo holandés.
                    
                    A comienzos del siglo XVII, el siglo de oro de los Países Bajos permitió a la Compañía Neerlandesa de las Indias Orientales aumentar su comercio con China y la importación de la porcelana como artículo de lujo solo al alcance de las clases más adineradas neerlandesas.
                    En busca de un producto más accesible, los ceramistas de Delft desarrollaron una floreciente industria de loza fina capaz de hacerle la competencia a los objetos importados.</p>
